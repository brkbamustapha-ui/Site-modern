...
export function ScrollIndicator() {
  ...
  return (
    <div className="pointer-events-none absolute bottom-10 left-1/2 flex -translate-x-1/2 flex-col items-center gap-3 text-cream/70">
      <span className="text-[10px] font-medium uppercase tracking-[0.35em]">Scroll</span>
      <motion.div
        className="h-12 w-px bg-gradient-to-b from-gold-soft to-transparent"
